...
(function (global, factory) {
  ...
  var BufferController = /*#__PURE__*/function (_Logger) {
    ...
    _proto.createSourceBuffers = function createSourceBuffers(tracks) {
      ...
      var _loop = function _loop(trackName) {
        if (!sourceBuffer[trackName]) {
          ...
          try {
            var sb = sourceBuffer[trackName] = mediaSource.addSourceBuffer(_this11.refineMimeType(mimeType));
    ...
    _proto.refineMimeType = function refineMimeType(mimeType) {
      if (mimeType.includes("hvc1") || mimeType.includes("hev1")) {
        ...
        var filteredParts = parts.filter(function (part) {
          return !part.includes("hvc1") && !part.includes("hev1");
        });
      ...
      var _play = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return (_this$media = this.media) == null ? void 0 : _this$media.play();
            case 2:
            case "end":
